...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return SpikeBall; });
class SpikeBall {
...
class Player {
  constructor(scene, x, y) {
    this.scene = scene;
    const anims = scene.anims; //new anims
...
/* harmony import */ var _HUD_js__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_HUD_js__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var rx__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! rx */ "./node_modules/rx/dist/rx.all.js");
/* harmony import */ var rx__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(rx__WEBPACK_IMPORTED_MODULE_3__);
...
class ArenaScene extends Phaser.Scene {
  ...
  create() {
    ...
    let gameOver = false; // Parameters are the name you gave the tileset in Tiled and then the key of the tileset image in
    ...
    this.createHUD(this.player.health); // Constrain the camera so that it isn't allowed to move outside the width/height of tilemap
